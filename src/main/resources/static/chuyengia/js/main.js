...
$( document ).ready(function() {
    ...
    <div class="listmenumain">
        <a href="vandongvien"><i class="fa fa-users"></i> Hồ sơ vdv</a>
        <a href="lichkham"><i class="fa fa-calendar"></i> Lịch khám</a>
        <a href="tranthuong"><i class="fa fa-medkit"></i> trấn thương</a>
...
async function checkroleChuyenGia() {
    ...
    var url = 'http://localhost:8080/api/user/expert/check-role-expert';
    const response = await fetch(url, {
        method: 'GET',
        headers: new Headers({
            'Authorization': 'Bearer ' + token
