...
$( document ).ready(function() {
    ...
    <div class="listmenumain">
        <a href="index"><i class="fa fa-dashboard"></i> Trang chủ</a>
        <a href="taikhoan"><i class="fa fa-users"></i> Tài khoản</a>
        <a href="chuyenmon"><i class="fa fa-list"></i> Chuyên môn</a>
        <a href="vandongvien"><i class="fa fa-user"></i> Vận động viên</a>
        <a href="thuchi"><i class="fa fa-money"></i> Thu chi</a>
        <a href="giaidau"><i class="fa fa-calendar"></i> Giải đấu</a>
